...
-- RLS policies for integrations (apenas admin)
...
-- RLS policies for sync_logs (apenas admin)
...
-- Function to update gallery image count
...
-- Trigger to update gallery image count automatically
