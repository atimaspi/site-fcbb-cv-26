      ...
      <div className="flex justify-between items-center">
        <Link to="/" className="flex items-center focus-visible-cv" aria-label="FCBB">
          ...
          <div className="flex flex-col">
            <h1 className="text-xl font-bold text-cv-blue leading-tight">FCBB</h1>
        ...
        <div className="hidden lg:flex items-center space-x-3">
          <Link 
            ...
            className="text-xs px-3 py-1.5 border border-cv-blue text-cv-blue hover:bg-cv-blue hover:text-white rounded transition-colors font-medium"
          >
            FIBA LiveStats
          </Link>
          <Link 
            to="/contacto"
            className="text-xs px-3 py-1.5 bg-cv-blue text-white hover:bg-blue-700 rounded transition-colors font-medium"
          >
            Contactos
          </Link>
        </div>
