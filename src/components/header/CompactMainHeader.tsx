      ...
      <div className="flex justify-between items-center">
        <Link to="/" className="flex items-center focus-visible-cv" aria-label="FCBB">
          ...
          <div className="flex flex-col">
            <h1 className="text-2xl font-bold text-cv-blue leading-tight">FCBB</h1>
            <p className="text-sm text-cv-dark font-medium">Federação Cabo-verdiana de Basquetebol</p>
          </div>
        </Link>
