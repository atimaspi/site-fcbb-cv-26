      ...
      <div className="flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-4">
          <Link 
            ...
            className="px-4 py-2 border border-cv-blue text-cv-blue hover:bg-cv-blue hover:text-white rounded transition-colors font-medium"
          >
            FIBA LiveStats
          </Link>
          <Link 
            to="/contacto"
            className="px-4 py-2 bg-cv-blue text-white hover:bg-blue-700 rounded transition-colors font-medium"
          >
            Contactos
          </Link>
        </div>
