    ...
    <PageLayout title="Seleção Feminina">
      <div className="prose max-w-none mt-8">
        <p className="mb-4 text-gray-700">
          A Seleção Feminina de Basquetebol de Cabo Verde representa o país em competições internacionais de basquetebol.
        </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[...Array(12)].map((_, index) => (
              <div key={index} className="border p-4 rounded flex items-center">
                ...
                <div>
                  <h3 className="font-semibold">Jogadora {index + 1}</h3>
